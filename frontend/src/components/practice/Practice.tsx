...
import {fetchFlashcards, fetchQuestions, fetchWordsForVisonMode} from "@/lib/practice.api"
import type {DictionaryItem, Lesson, PracticeMode, Question} from "@/types/type"
...
export default function Practice() {
  ...
  useEffect(() => {
    ...
    fetchWordsForVisonMode().then(setWords)
  }, [])
  ...
  return (
      <div className="min-h-screen p-6 max-w-4xl mx-auto">
        ...
        {mode === "vision" && (
            <VisionMode index={index} onNext={() => next(words.length)} words={words}></VisionMode>
        )}
