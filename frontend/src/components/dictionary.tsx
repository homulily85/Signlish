...
import { Search, ArrowLeft, Play, Book } from "lucide-react"
...
const mockData = [
  {
    id: 1,
    word: "Hello",
    definition: "A greeting used to acknowledge someone or get their attention.",
    videoUrl: "/hello-sign-language.jpg",
    thumbnailUrl: "/hello-sign-language.jpg",
    instructions:
      "Extend your hand outward from your forehead, like a salute. Move your hand forward and away from your head in a small arc.",
    category: "Greetings",
    popularity: 95,
  },
  {
    ...
    videoUrl: "/thank-you-sign-language.jpg",
    thumbnailUrl: "/thank-you-sign-language.jpg",
    instructions:
      "Touch your chin or lips with your fingertips, then move your hand forward toward the person you are thanking.",
    category: "Manners",
    popularity: 92,
  },
  {
    ...
    videoUrl: "/please-sign-language.jpg",
    thumbnailUrl: "/please-sign-language.jpg",
    instructions:
      "Place your flat hand on your chest and move it in a circular motion, like rubbing your chest in a clockwise direction.",
    category: "Manners",
    popularity: 88,
  },
  {
    id: 4,
    word: "Love",
    definition: "A deep feeling of affection and care for someone or something.",
    videoUrl: "/love-sign-language.jpg",
    thumbnailUrl: "/love-sign-language.jpg",
    instructions: "Cross both arms over your chest with closed fists, as if hugging yourself.",
    category: "Emotions",
    popularity: 90,
  },
]
...
export default function SignLanguageDictionary() {
  const [selectedWord, setSelectedWord] = React.useState<(typeof mockData)[0] | null>(null)
  ...
  const filteredWords = mockData.filter((word) => word.word.toLowerCase().includes(searchValue.toLowerCase()))

  const handleWordSelect = (word: (typeof mockData)[0]) => {
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <header className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-balance text-foreground">Sign Language Dictionary</h1>
            </div>
                        ...
                        {filteredWords.map((word) => (
                          ...
                          >
                            <div className="flex items-center gap-3 w-full">
                              <img
                                src={word.thumbnailUrl || "/placeholder.svg"}
                                alt={`${word.word} sign`}
                ...
                >
                  <CardContent className="p-0">
                    <div className="flex flex-col sm:flex-row gap-4 p-4">
                      {/* Video Thumbnail */}
                      <div className="relative sm:w-48 h-40 sm:h-32 rounded-lg overflow-hidden bg-muted flex-shrink-0">
                        <img
                          src={word.thumbnailUrl || "/placeholder.svg"}
          ...
          <CardContent className="p-6 md:p-8">
            ...
            <div className="mb-8">
              ...
              <div className="relative aspect-video rounded-lg overflow-hidden bg-muted shadow-md">
                <img
                  src={selectedWord.videoUrl || "/placeholder.svg"}
              ...
              <Card className="bg-muted border-border">
                <CardContent className="p-6">
                  <ol className="space-y-3">
                    {selectedWord.instructions.split(". ").map((step, index) => (
                      <li key={index} className="flex gap-3 text-base leading-relaxed">
                        <span className="flex-shrink-0 flex items-center justify-center w-7 h-7 rounded-full bg-primary text-primary-foreground font-bold text-sm">
                          {index + 1}
                        </span>
                        <span className="flex-1 pt-0.5 text-pretty text-foreground">
                          {step.trim()}
                          {index < selectedWord.instructions.split(". ").length - 1 ? "." : ""}
                        </span>
                      </li>
                    ))}
                  </ol>
