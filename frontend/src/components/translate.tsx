...
import { Upload, Camera, Mic, RefreshCcw, Play, Loader2, Video } from "lucide-react"
...
export default function TranslatePage() {
  ...
  const handleTranslateText = useCallback(() => {
    ...
    setTimeout(() => {
      // Mock video URL
      setSignVideoUrl("/sign-language-video.png")
                    ...
                    <div className="space-y-4">
                      ...
                      {!videoFile ? (
                        ...
                        >
                          ...
                          <p className="text-muted-foreground text-center">Click to upload a sign language video</p>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex gap-2">
                            <Button variant="outline" onClick={handleUploadDifferent} className="flex-1 bg-transparent">
                              <RefreshCcw className="h-4 w-4 mr-2" />
                              Upload Different
                            </Button>
                            <Button onClick={handleTranslateVideo} disabled={isTranslatingVideo} className="flex-1">
                              {isTranslatingVideo ? (
                                <>
                  ...
                  <div className="relative rounded-lg overflow-hidden bg-muted min-h-[300px] flex items-center justify-center">
                    {!signVideoUrl ? (
                      ...
                      <div className="relative w-full">
                        <img
                          src={signVideoUrl || "/placeholder.svg"}
